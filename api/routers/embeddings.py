...
from ..models import EmbeddingBody
...
async def embedding(request: Request, data: EmbeddingBody = Body(...)) -> Union[Response, dict]:
    ...
    is_model_premium = data.model in AIModel.get_all_models("embeddings", premium=True)
